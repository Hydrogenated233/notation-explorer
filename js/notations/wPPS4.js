;
/**
 * Parented Predecessor Sequence 4 weak (wPPS4)
 *
 * 与 PPS4 的区别：强展开判定中，"小于等于b" 改成 "等于b"
 *
...
(function () {
  ...
  function expand(seq, FSterm) {
    ...
    // --- 构造结果 ---
    // 总长度 = y + n*L (n从0开始，FS(0)长度为y，FS(n)长度=y+nL)
  ...
  register.push({
    ...
    fromDisplay: function (str) {
      ...
      if (result.find(Number.isNaN) !== undefined) throw new Error("Illegal wPPS4 sequence");
      return result;
    },
    able: function (seq) {
